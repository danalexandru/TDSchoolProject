...
save_as_csv_files(dict_healthy_mean_freq, dict_broken_mean_freq, 'mean_freq');
...
save_as_csv_files(dict_healthy_freq_magn, dict_broken_freq_magn, 'freq_magn');
...
save_as_csv_files(dict_healthy_kustosis_measure, dict_broken_kustosis_measure, 'kustosis');
...
save_as_csv_files(dict_healthy_skewness_measure, dict_broken_skewness_measure, 'skewness');
...
save_as_csv_files(dict_healthy_signal_entropy, dict_broken_signal_entropy, 'entropy');
...
save_as_csv_files(dict_healthy_iqr_data, dict_broken_iqr_data, 'iqr');
