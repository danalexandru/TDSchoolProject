...
save([path 'dict_healthy_mean_freq.mat'], 'dict_healthy_mean_freq');
save([path 'dict_broken_mean_freq.mat'], 'dict_broken_mean_freq');
...
save([path 'dict_healthy_freq_magn.mat'], 'dict_healthy_freq_magn');
save([path 'dict_broken_freq_magn.mat'], 'dict_broken_freq_magn');
...
save([path 'dict_healthy_kustosis_measure.mat'], 'dict_healthy_kustosis_measure');
save([path 'dict_broken_kustosis_measure.mat'], 'dict_broken_kustosis_measure');
...
save([path 'dict_healthy_skewness_measure.mat'], 'dict_healthy_skewness_measure');
save([path 'dict_broken_skewness_measure.mat'], 'dict_broken_skewness_measure');
...
save([path 'dict_healthy_signal_entropy.mat'], 'dict_healthy_signal_entropy');
save([path 'dict_broken_signal_entropy.mat'], 'dict_broken_signal_entropy');
...
save([path 'dict_healthy_iqr_data.mat'], 'dict_healthy_iqr_data');
save([path 'dict_broken_iqr_data.mat'], 'dict_broken_iqr_data');
